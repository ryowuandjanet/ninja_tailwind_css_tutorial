     ...
     <nav class='text-right'>
       <div class="flex justify-between items-center">
         <h1 class="font-bold uppercase p-4 border-b border-gray-100">
           <a href="/" class="hover:text-red-700">Food Ninja</a>
         </h1>
       ...
       <ul class="text-sm mt-6 hidden md:block" id="menu">
        <li clas="text-gray-700 font-bold">
      ...
      <div>
        ...
        <div class="mt-8 grid lg:grid-cols-3 gap-10">
          <div class="card hover:shadow-lg">
            <img src="img/UL_logo.png" alt="ul" class="w-full h-32 sm:h-48 object-cover">
            <div class="m-4">
              <span class="font-bold">UL Logo</span>
              <span class="block text-gray-500 text-sm">Recipe by Mario</span>
            </div>
            <div class="badge">
              <svg class="w-5 inline-block" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="card hover:shadow-lg">
            <img src="img/CE_logo.png" alt="ce" class="w-full h-32 sm:h-48 object-cover">
            <div class="m-4">
              <span class="font-bold">CE Logo</span>
              <span class="block text-gray-500 text-sm">Recipe by Mario</span>
            </div>
            <div class="badge">
          ...
          <div class="card hover:shadow-lg">
            <img src="img/TAF_logo.png" alt="taf" class="w-full h-32 sm:h-48 object-cover">
            <div class="m-4">
              <span class="font-bold">CE Logo</span>
              <span class="block text-gray-500 text-sm">Recipe by Mario</span>
            </div>
